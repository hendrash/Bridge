...
export const bridgeSocket = () => {
	...
	console.log("socket")
	return new webSocketProvider.eth.Contract((BridgeEvent as any), networkConfig().TransferToUSDC)
}
export const bridgeEvent = () => {
	...
	return new web3Provider.eth.Contract((BridgeEvent as any), networkConfig().TransferToUSDC)
}
